...
export default function Footer() {
  return (
    <footer className="mt-auto border-t border-ink/12 bg-ink text-paper">
      <Reveal className="mx-auto flex max-w-6xl flex-col gap-4 px-6 py-10 md:flex-row md:items-center md:justify-between">
        ...
        <a
          ...
          className="font-mono text-[12px] uppercase tracking-wide text-paper/80 underline decoration-paper/30 underline-offset-4 transition-colors hover:text-insert"
        >
          Source on GitHub
        </a>
      </Reveal>
